...
class XPDNet(nn.Module):
    ...
    def forward(self, x):
        ...
        with timer.env("depth_final"):
            depth_pred = self.depth_estimator(depth_features, mask_features)
...
if __name__ == "__main__":
    ...
    def parse_args(argv=None):
        parser = argparse.ArgumentParser(description="For XPDNet Debugging and Inference Time Measurement")
        parser.add_argument(
            "--trained_model",
            default=None,
            type=str,
