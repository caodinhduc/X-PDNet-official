...
scannet_dataset = dataset_base.copy({
    ...
    'train_images': '../datasets/scannet/',
    'train_info':   '../datasets/scannet_annotation/scannet_train.json',

    # Validation images and annotations.
    'valid_images': '../datasets/scannet/',
    'valid_info':   '../datasets/scannet_annotation/scannet_val.json',

    # Evaluation images and annotations.
    'eval_images': '../datasets/scannet/',
    'eval_info':   '../datasets/scannet_annotation/scannet_eval.json',
...
XPDNet_101_config = XPDNet_base_config.copy(
    {
        'name': 'XPDNet_101',
        'lr_steps': (62500, 100000),
        # Backbone Settings
...
XPDNet_50_config = XPDNet_101_config.copy(
    {
        'name': 'XPDNet_50',
        # Backbone Settings
